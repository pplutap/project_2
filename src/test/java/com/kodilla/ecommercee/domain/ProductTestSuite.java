...
public class ProductTestSuite {
    ...
    public void testGetProductsFromGroupAfterSavingProducts(){
        ...
        Product product1 = new Product("Product 1", "Description 1", new BigDecimal("100"), group);
        Product product2 = new Product("Product 2", "Description 2", new BigDecimal("200"), group);
        ...
        List<Product> productsFromRetrievedGroup = retrievedGroup.getProductList();

        //Then
        assertEquals(2, productsFromRetrievedGroup.size());
    ...
    public void testDeleteProduct(){
        ...
        assertEquals(0, groupRepository.findById(groupId).get().getProductList().size());
